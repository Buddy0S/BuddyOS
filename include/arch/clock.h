...
#define CM_PER_L4LS_CLKCTRL (PRCM_BASE + 0x60)
#define CM_PER_L3_CLKKCTRL (PRCM_BASE + 0xE0)
#define CM_WKUP_CLKSTCTRL (CM_WKUP_BASE + 0x0)
#define CM_PER_L4LS_CLKSTCTRL (PRCM_BASE + 0x00)
#define CM_PER_L3_CLKSTCTRL (PRCM_BASE + 0x0C)
